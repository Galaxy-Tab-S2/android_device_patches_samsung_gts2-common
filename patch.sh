...
if [ $(cat ${LOCAL_PATH}/PATCHED) = "0" ]; then
	...
	make_patch_stamp 'gralloc_priv.h' ${TOP}/hardware/samsung/slsi-cm_exynos5433/include

	if [ ! -d ${TOP}/hardware/samsung/slsi-cm_exynos5433/include/.backup ]; then

		mkdir ${TOP}/hardware/samsung/slsi-cm_exynos5433/include/.backup
		echo "THIS DIR CONTAINS UNTOUCHED/UNPATCHED FILES, DO NOT REMOVE! THIS DIR WILL GET REMOVED AUTOMATICALLY IF NECCESSARY" > ${TOP}/hardware/samsung/slsi-cm_exynos5433/include/.backup/README
